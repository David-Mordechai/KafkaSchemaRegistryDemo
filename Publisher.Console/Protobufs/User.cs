...
namespace ProtoDtos {
  ...
  /// <summary>Holder for reflection information generated from Protobufs/user.proto</summary>
  public static partial class UserReflection {

    #region Descriptor
    /// <summary>File descriptor for Protobufs/user.proto</summary>
    ...
    static UserReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChRQcm90b2J1ZnMvdXNlci5wcm90bxIJUHJvdG9EdG9zIl8KBFVzZXISEAoI",
            "RnVsbE5hbWUYASABKAkSFgoORmF2b3JpdGVOdW1iZXIYAiABKAUSFQoNRmF2",
            "b3JpdGVDb2xvchgDIAEoCRIWCg5OZXdTdHJpbmdGaWVsZBgEIAEoCWIGcHJv",
            "dG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::ProtoDtos.User), global::ProtoDtos.User.Parser, new[]{ "FullName", "FavoriteNumber", "FavoriteColor", "NewStringField" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::ProtoDtos.UserReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public User(User other) : this() {
      ...
      newStringField_ = other.newStringField_;
    ...
    /// <summary>Field number for the "NewStringField" field.</summary>
    public const int NewStringFieldFieldNumber = 4;
    private string newStringField_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string NewStringField {
      get { return newStringField_; }
      set {
        newStringField_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(User other) {
      ...
      if (NewStringField != other.NewStringField) return false;
    ...
    public override int GetHashCode() {
      ...
      if (NewStringField.Length != 0) hash ^= NewStringField.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (NewStringField.Length != 0) {
        ...
        output.WriteString(NewStringField);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (NewStringField.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(NewStringField);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(User other) {
      ...
      if (other.NewStringField.Length != 0) {
        NewStringField = other.NewStringField;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 34: {
            NewStringField = input.ReadString();
            break;
          }
        }
      }
